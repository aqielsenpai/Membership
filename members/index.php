...
<body>
    ...
    <div class="w3-bar w3-black">
        ...
        <a href="#" class="w3-bar-item w3-button w3-mobile">Events/Activities</a>
        <a href="#" class="w3-bar-item w3-button w3-mobile">Resources</a>
        <a href="#" class="w3-bar-item w3-button w3-mobile">Support</a>
        <a href="#" class="w3-bar-item w3-button w3-mobile">Membership</a>
