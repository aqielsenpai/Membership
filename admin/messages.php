...
<body>
    ...
    <div style="min-height:100vh;overflow-y: auto; margin:auto; max-width:800px; ">
        ...
        <div class=" w3-container w3-padding-large " >
            <?php if ($result2->num_rows > 0) {
                ...
                while ($row = $result2->fetch_assoc()) {
                    ...
                    if ($member_id == 1){  //admin_id must be 1
                        //echo "<div class='w3-right w3-card w3-container w3-margin' style = 'max-width:800px'> $messagedetails_content   <p> $mydate2</p> </div><br>";
                        echo "<tr><td><div class = 'w3-yellow w3-container w3-card w3-padding-large w3-right w3-margin'>$mydate2 $messagedetails_content</div></td></tr> ";
                    }
                    else{
                        //echo "<div class='w3-left w3-card w3-container w3-margin' style = 'max-width:800px'> $messagedetails_content   <p> $mydate2</p> </div><br>";
                        echo "<tr><td><div class = 'w3-red w3-container w3-card w3-padding-large w3-left w3-margin'>$mydate2 $messagedetails_content</div></td></tr>  ";
                    }
